  ...
  render() {
    return (
      <div>
        ...
        <h2>
          부모로 부터 전달받은 값 : {this.props.dongjun} {this.props.test}
        </h2>
      </div>
    );
  }
...
class Exam0 extends Component {
  // React.Component 클래스 상속받아 클래스형 컴포넌트 정의
}
// 다른 파일에서 해당파일(Exam1.jsx)의 기본으로 지정된 (Exam1)를 사용할 수 있도록
// 내보냄(수출함)
export default Exam0;
